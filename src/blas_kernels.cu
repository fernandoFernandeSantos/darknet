...
//extern "C"
void adam_gpu(int n, real_t *x, real_t *m, real_t *v, real_t B1, real_t B2,
...
//extern "C"
void adam_update_gpu(real_t *w, real_t *d, real_t *m, real_t *v, real_t B1,
...
//extern "C"
void normalize_delta_gpu(real_t *x, real_t *mean, real_t *variance,
...
//extern "C"
void mean_delta_gpu(real_t *delta, real_t *variance, int batch, int filters,
...
//extern "C"
void fast_mean_delta_gpu(real_t *delta, real_t *variance, int batch,
		int filters, int spatial, real_t *mean_delta) {
...
//extern "C"
void fast_variance_delta_gpu(real_t *x, real_t *delta, real_t *mean,
		real_t *variance, int batch, int filters, int spatial,
		real_t *variance_delta) {
...
//extern "C"
void normalize_gpu(real_t *x, real_t *mean, real_t *variance,
...
//extern "C"
void l2normalize_gpu(real_t *x, real_t *dx, int batch, int filters,
		int spatial) {
...
//extern "C"
void fast_mean_gpu(real_t *x, int batch, int filters, int spatial,
		real_t *mean) {
...
//extern "C"
void fast_variance_gpu(real_t *x, real_t *mean, int batch, int filters,
		int spatial, real_t *variance) {
...
//extern "C"
void variance_gpu(real_t *x, real_t *mean, int batch, int filters, int spatial,
		real_t *variance) {
...
//extern "C"
void axpy_gpu_offset(int N, real_t ALPHA, real_t * X, int OFFX, int INCX,
		real_t * Y, int OFFY, int INCY) {
...
//extern "C"
void copy_gpu_offset(int N, real_t * X, int OFFX, int INCX, real_t * Y,
		int OFFY, int INCY) {
...
//extern "C"
void flatten_gpu(real_t *x, int spatial, int layers, int batch, int forward,
		real_t *out) {
...
//extern "C"
void reorg_gpu(real_t *x, int w, int h, int c, int batch, int stride,
...
//extern "C"
void scale_mask_gpu(int N, real_t * X, real_t mask_num, real_t * mask,
		real_t scale) {
...
//extern "C"
void shortcut_gpu(int batch, int w1, int h1, int c1, real_t *add, int w2,
...
//extern "C"
void smooth_l1_gpu(int n, real_t *pred, real_t *truth, real_t *delta,
		real_t *error) {
...
//extern "C"
void softmax_x_ent_gpu(int n, real_t *pred, real_t *truth, real_t *delta,
		real_t *error) {
...
//extern "C"
void logistic_x_ent_gpu(int n, real_t *pred, real_t *truth, real_t *delta,
		real_t *error) {
...
//extern "C"
void wgan_gpu(int n, real_t *pred, real_t *truth, real_t *delta,
		real_t *error) {
...
//extern "C"
void weighted_delta_gpu(real_t *a, real_t *b, real_t *s, real_t *da, real_t *db,
		real_t *ds, int num, real_t *dc) {
...
//extern "C"
void softmax_tree(real_t *input, int spatial, int batch, int stride,
...
//extern "C"
void softmax_gpu(real_t *input, int n, int batch, int batch_offset, int groups,
...
//extern "C"
void upsample_gpu(real_t *in, int w, int h, int c, int batch, int stride,
