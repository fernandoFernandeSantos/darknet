...
#if REAL_TYPE == HALF
	curandStatus_t (*curand_generate_uniform)() = curandGenerateUniform;
#elif REAL_TYPE == FLOAT
	curandStatus_t (*curand_generate_uniform)() = curandGenerateUniform;
#elif REAL_TYPE == DOUBLE
	curandStatus_t (*curand_generate_uniform)() = curandGenerateUniformDouble;
#endif

	curand_generate_uniform(gen[i], x_gpu, n);
