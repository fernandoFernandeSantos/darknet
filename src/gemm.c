...
void time_random_matrix(int TA, int TB, int m, int k, int n)
{
    ...
    printf("Matrix Multiplication %dx%d * %dx%d, TA=%d, TB=%d: %lf ms\n",m,k,k,n, TA, TB, (real_t)(end-start)/CLOCKS_PER_SEC);
    free(a);
    free(b);
    free(c);
}
...
void gemm_nn(int M, int N, int K, real_t ALPHA, 
        real_t *A, int lda, 
        real_t *B, int ldb,
        real_t *C, int ldc)
{
...
void gemm_nt(int M, int N, int K, real_t ALPHA, 
        real_t *A, int lda, 
        real_t *B, int ldb,
        real_t *C, int ldc)
{
...
void gemm_tn(int M, int N, int K, real_t ALPHA, 
        real_t *A, int lda, 
        real_t *B, int ldb,
        real_t *C, int ldc)
{
...
void gemm_tt(int M, int N, int K, real_t ALPHA, 
        real_t *A, int lda, 
        real_t *B, int ldb,
        real_t *C, int ldc)
{
