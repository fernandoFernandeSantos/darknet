...
#if REAL_TYPE == HALF
	cublasStatus_t (*cublas_gemm)() = cublasHgemm;
#elif REAL_TYPE == FLOAT
	cublasStatus_t (*cublas_gemm)() = cublasSgemm;
#elif REAL_TYPE == DOUBLE
	cublasStatus_t (*cublas_gemm)() = cublasDgemm;
#endif

	cudaError_t status = cublas_gemm(handle, (TB ? CUBLAS_OP_T : CUBLAS_OP_N),
